...
//level three(3)
block25 = new Block(690, 105, 30, 40);
  polygon = Matter.Bodies.circle(80, 300, 20);
  World.add(world, polygon);
  sling = new SlingShot(polygon, {x:80, y:300});
...
function draw() {
  ...
  textSize(20);
  fill("lightyellow");
  text("press space for another chance!", 40, 40);
  //polygon1.display();
sling.display();
  ground.display();
  stand1.display();
...
function keyPressed(){
	if(keyCode===32){
		Matter.Body.setPosition(this.polygon,{x:80,y:300})
